...
import pytest
from source_kaggle.source import KaggleStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(KaggleStream, "path", "v0/example_endpoint")
    mocker.patch.object(KaggleStream, "primary_key", "test_primary_key")
    mocker.patch.object(KaggleStream, "__abstractmethods__", set())
